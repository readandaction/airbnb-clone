...
class UserProfileView(mixins.LogInRequiredView, DetailView):
    model = models.User
    context_object_name = "user_obj"


class UpdateProfileView(mixins.LogInRequiredView, SuccessMessageMixin, UpdateView):
    model = models.User
    fields = (
        "first_name",
        "last_name",
